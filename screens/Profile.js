...
export default class Profile extends Component {
    ...
    render(){
         return (
          <View style = {this.state.light_theme ? this.state.containerLight : styles.container}>
          ...
          <View style = {styles.appTitle}>
              ...
              <View style = {this.state.light_theme ? styles.appTitleTextContainerLight : styles.appTitleText}>
